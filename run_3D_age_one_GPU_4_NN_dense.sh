...
###########
#result=result/bz_${batch_size}_range_bb_NN_dense_rgb
result=result/bz_${batch_size}_range_bbOK_NN_dense_rgb_aug_dp
...
#python train_eval_3D_age_one_GPU_ageRange_batchBalance_NN.py --save_path $save_path --data_path $data_path \
##################
#python train_eval_3D_age_one_GPU_ageRange_batchBalance_NN_dense_addrgb.py --save_path $save_path --data_path $data_path \
python train_eval_3D_age_one_GPU_ageRange_batchBalanceOK_NN_dense_addrgb_aug_dp.py --save_path $save_path --data_path $data_path \
--train_log_path $train_log_path --test_log_path $test_log_path --batch_size $batch_size \
--gpu_num 1 \
--learning_rate 1e-2 \
>log/RS_bz10_one_GPU_range_bbOK_NN_dense_rgb_aug_dp.log
#--learning_rate 1e-4 
#--learning_rate 1e-2 \
#> log/RS_bz10_one_GPU_range_bb_NN_dense_rgb.log
