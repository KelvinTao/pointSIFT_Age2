...
class ClassTrainer(object):
   ...
   ##not used
    ...
    def load_data(self):
        ...
        train_data.append(self.get_group10(train_data[2]))
    ...
    def get_batch_balance_wdp(self, dataset):
        points, feature, labels, _ ,groupIndexes= dataset
        indexUse=[]
    ...
    def get_batch_wdp(self, dataset, idxs, start_idx, end_idx):
        ...
        ps0, fea0, seg0, smpw0,_ = dataset  #[list]
