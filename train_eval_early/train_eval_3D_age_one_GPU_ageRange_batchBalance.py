...
class ClassTrainer(object):
    ...
    def load_data(self):
        ...
        train_data=self.load_data_npz(DATA_PATH+'/sampleTrain3332_21000.npz')#[["image"], ["age_label"]]
        ...
        test_data=self.load_data_npz(DATA_PATH+'/sampleTest1000page_21000.npz')##list[[np],[np]]
