...
class ClassTrainer(object):
    ...
    def calweights(self,num_age):
        ##input: num_age, Nsample  , age value
        ##output: 
    ...
    def build_g_gpu(self, gpu_idx):
        ...
        with tf.device('/gpu:%d' % gpu_idx), tf.name_scope('gpu_%d' % gpu_idx) as scope:
            ...
            self.loss = AGE_MODEL.get_loss(self.net,label_slice,smpws=smpws_slice)
            ##gradients
            ...
            with tf.Session(config=config) as sess:
                ...
                for epoch in range(epoch_sz):
                    ...
                    for _iter in range(iter_in_epoch):
                        ...
                        batch_data, batch_feature,batch_label, batch_smpw = self.get_batch_wdp(self.train_data, train_idxs,
                                                                                 start_idx, end_idx)
