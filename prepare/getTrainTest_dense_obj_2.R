...
##
write.csv(sampleUse,file=paste0(path,'/phe/sampleUse_4332_21000.csv'),row.names=F,quote=F)
...
##
write.csv(testSet,file=paste0(path,'/phe/sampleTest1000page_21000.csv'),row.names=F,quote=F)
write.csv(trainSet,file=paste0(path,'/phe/sampleTrain3332_21000.csv'),row.names=F,quote=F)
