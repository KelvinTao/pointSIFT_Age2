...
##train
filePath=path+'/phe/sampleTrain3332_21000.csv'
points,label=mkdata(filePath)
np.savez(path+'/data/sampleTrain3332_21000.npz',points_set=points,age_label_set=label)
##test
filePath=path+'/phe/sampleTest1000page_21000.csv'
points,label=mkdata(filePath)
np.savez(path+'/data/sampleTest1000page_21000.npz',points_set=points,age_label_set=label)
